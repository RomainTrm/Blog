...
If you're working in IT, you've probably already encountered the "No deploy on Friday" mantra/dogma. It's so ubiquitous that they're many memes about it on the internet.

![Several meme about "No deploy on Friday"](1.png)

Recently, one of my LinkedIn relations commented a post that way saying something like "If you had to deploy today (Friday) and it went wrong, I'm sorry for you." In his comment, he argued that he had shipped more than 10 versions that day and it was no big deal for him, starting a discussion with the author of the post. As I was reading them, I realized they were both right, and above all, by their positioning about "no deploy on Friday" I could make a lot of guessing about their respective business and organizational contexts as well as their technical practices.
...
Obviously, this ability to deploy often doesn't come for free, it requires some technical skills and extra work to be able to increase deployment frequency. I'm thinking of *zero downtime deployment* capability that allows teams to deploy at any time without impacting users.  
...
> If we're working on a new feature that remains disabled in production, even though we deploy it daily, we're not sure that the code is working properly. If a bug appears the day we choose to flip the *toggle*, we will need to investigate the whole feature's code and not assume that the bug is hidden in the latest release changes.
...
As I tried to highlight it, the "no deploy on Friday" rule of thumb is a defensive practice aiming to preserve everyone's weekends. Though, the relevance of this rule depends a lot on the context: Does the business constraints (goals, financial, legal) justifies it? Is it the result of the team's organization and processes? Can it be mitigated by some technical capabilities?  

I let you judge of the revelance of the rule in your own context. But now I believe that, depending on how you're using this joke, it says more about your work that you may initially thought.  
