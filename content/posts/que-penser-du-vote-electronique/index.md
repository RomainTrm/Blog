...
Aujourd'hui, j'ai envie de vous parler d'un cas d'usage concret et des impacts qu'il aurait, selon moi, sur le fonctionnement même de notre démocratie. Bien entendu, j'ai une orientation politique, mais il n'est pas question ici de vous en faire la promotion.

Cela fait maintenant plusieurs mois que je réfléchis à l'usage du vote électronique pour nos différents scrutins nationaux (élections présidentielles, législatives, européennes). Si cette réflexion est restée longtemps à l'état d'idées, notamment parce qu'aucune d'elles n'est réellement nouvelle dans le débat public, une récente [tribune](https://www.lemonde.fr/idees/article/2026/05/06/l-extension-du-vote-electronique-aux-scrutins-nationaux-doit-etre-envisagee_6686102_3232.html) sur le journal [Le Monde](https://www.lemonde.fr/) m'a décidé à les structurer pour en faire cet article de blog. Celui-ci se veut accessible à tous et ne requiert aucune connaissance technique particulière pour être lu.
...
Pour produire une critique éclairée sur le vote électronique, et décider si c'est une solution souhaitable ou non, il nous faut d'abord un point de comparaison, notre mode de fonctionnement actuel : le vote papier.

Tout commence avec une inscription sur les listes électorales. Un citoyen se voit rattaché à un bureau de vote, c'est l'unique endroit où il peut voter. Le jour de l'élection, s'il n'a pas fait de procuration, il se présente au dit bureau, prend des bulletins ainsi qu'une enveloppe puis se rend dans un isoloir. Dans le secret de cet isoloir, il place dans l'enveloppe le bulletin de son choix et se débarrasse des autres. Enfin, il se présente devant les assesseurs qui vérifient son identité, qu'il est bien rattaché à ce bureau de vote et s'il n'a pas déjà voté. Notre citoyen peut alors glisser son enveloppe dans l'urne. À la fin des horaires alloués aux votes, l'urne est ouverte, les voix sont décomptées et les résultats transmits au ministère de l'Intérieur.
...
Une fois les démarches en amont réalisées, le vote électronique, lui, consiste simplement à se connecter sur internet et réaliser son vote en ligne.  

Cela a effectivement de nombreux avantages. Il élimine les contraintes de présence et de déplacement jusqu'au bureau de vote le jour de l'élection, ce qui, sans nul doute, fera voter certaines personnes qui n'avaient pas les moyens ou l'envie de se déplacer. Ce système permet également un décompte plus rapide, c'est d'ailleurs pour cette raison que certains états aux États-Unis ont adopté un système sur des tablettes présentent dans les bureaux de vote. Enfin, comme cela a déjà été mentionné, nous disposons déjà des technologies nécessaires puisqu'une partie des Français expatriés votent de cette façon.

La toute première critique que l'on peut formuler à son égard est la même que celle formulée pour le vote papier : ce mode de scrutin exclut des personnes n'ayant pas accès à internet, qui ne savent pas se servir d'outils informatiques ou qui n'arrivent pas à réaliser des démarches en ligne.
...
Si l'on envisage le vote électronique, il nous faut sérieusement nous poser la question de la sécurité associée à ce mode de fonctionnement. Celle-ci me semble impossible à éluder dans un contexte où les annonces d'attaques et de fuites de données se multiplient sans cesse, y compris sur des [systèmes étatiques](https://www.lemonde.fr/idees/article/2026/05/20/fuites-de-donnees-l-etat-mauvais-eleve-de-la-securite_6691697_3232.html), de [la Police, la CAF, France Travail, l'Éducation Nationnale, l'URSSAF, le SIE, ...](https://www.01net.com/actualites/cyberattaques-france-dernieres-fuites-donnees-entreprises-touchees.html). Certaines de ces attaques ont d'ailleurs été réalisées par [de simples adolescents](https://www.01net.com/actualites/ados-quete-notoriete-qui-sont-vraiment-pirates-qui-volent-donnees-francais.html). À partir de ce simple constat, même en tant que développeur, il me parait tout de suite suspicieux de nous promettre une solution technique réellement sûre.  

<figure>

  ![Planche de BD en anglais. Des journalistes interrogent des professionnels de divers secteurs d'activité. Les experts se montrent confiants dans les avions et les ascenseurs. Les informaticiens rejettent la notion de sécurité pour le vote électronique, argumentant que toute l'industrie est dysfonctionnelle et qu'il ne faut pas croire les gens qui nous disent qu'une technologie est sûre, y compris la bockchain. Ils concluent au sujet du vote électronique par "N'y touchez pas. - Enterrez-le dans le désert. - Portez des gans."](1.png)  
  <figcaption>
    Crédit: <a href="https://xkcd.com/2030/" target="_blank">https://xkcd.com/2030/</a>
  </figcaption>
</figure>
...
Comme nous l'avons déjà mentionné, la France compte aujourd'hui environ 65000 bureaux de vote. Il ne parait pas imaginable que chacun de ces bureaux héberge un système pour le vote électronique des électeurs qui lui sont rattachés : ils n'en auront pas tous les compétences ni les moyens techniques nécessaires. Nous nous dirigerions alors vers un système beaucoup plus centralisé.  
...
## D'autres formes de manipulation plus insidieuses

Jusqu'à maintenant, j'ai traité la possibilité d'une manipulation de nos votes sous l'angle d'une attaque informatique, mais nous pouvons également imaginer d'autres formes de manipulations, plus diffuses qui pourraient vous toucher directement.  

Lors d'un vote dans un bureau, les assesseurs vérifient votre identité avant de vous laisser voter. Comment garantir, dans l'intimité de votre domicile, qu'il s’agit bien de vous qui utilisez votre voix et non d'un autre membre de votre foyer ? Vous perdez également cet espace confidentiel qu'est l'isoloir : votez-vous librement et selon vos convictions ou le faites-vous sous une forme de pression ou de contrainte ?

Un exemple concret : dans un contexte patriarcal et machiste qui subsiste toujours dans notre société, des femmes pourraient être rapidement dépossédées de leur droit de vote au profit d'hommes.

Enfin, si le vote reste en théorie anonyme, le simple fait de devoir s'identifier numériquement avant de voter peut influer sur les choix de vote. En effet, si un doute persiste quant à votre réel anonymat et que vous votez sous un régime autoritaire, alors voter pour une opposition politique pourrait vous apporter son lot de problèmes.

## Que faire alors du vote en ligne pour les expatriés ?

Si l'on suit le prolongement du raisonnement que je tiens jusqu'à maintenant, l'étape suivante serait de se demander si l'on souhaite même conserver le vote électronique pour nos expatriés. Je trouve cette idée dangereuse, car elle implique d'éloigner ces personnes de notre vie démocratique. J'estime qu'elles doivent garder voix au chapitre comme n'importe quel Français en âge de voter.  

Ici, tout est question de compromis, le vote électronique reste dans leur cas la meilleure solution, les risques énoncés précédemment étant largement mitigés par le nombre total de votants avec ce système.  

Je ne remets donc pas en cause l'usage du **vote électronique pour les expatriés**, au contraire, à défaut d'avoir une meilleure solution, **je le soutiens**.

## Une perte de contrôle des citoyens
